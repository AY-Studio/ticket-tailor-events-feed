...
add_action('admin_init', function() {
    register_setting('ay_ticket_tailor_settings_group', 'ay_ticket_tailor_api_key');
});
            ...
            <div class="tt-event-card">
                <a href="<?= $event['url']; ?>" target="_blank">
                    <figure class="latest__thumb card__img__hover">
                        <img src="<?= $event['header']; ?>" alt="<?= $event['name']; ?>">
                    </figure>
                </a>
                <div class="latest__cont">
                    ...
                    <div class="date__row">
                        <span class="lbl">From <?= format_pretty_date($event['start']); ?> to <?= format_pretty_date($event['end']); ?></span>
                    </div>
                </div>
            </div>
        <?php endforeach; ?>
